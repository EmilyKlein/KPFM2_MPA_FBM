plot.mc.pixel.C<-function(mc.object, quants = c(0.2, 0.5, 0.8), plot.trials = TRUE, annual.plots = TRUE, connector = "sum", page.layout = c(4, 4), Cylimits = c(0, 3), color.tags = NULL)
{
